...
1. The host clicks the headphones button in the top bar
...
3. Run:
   ...
   spicetify apply
   ```
4. Open Spotify — the 🎵 button appears in the top bar
...
- Click **Leave session** to disconnect — the only way to end your session
